...
CHECKPOINT_FINETUNE_NUM=${CHECKPOINT_FINETUNE_NUM:-12}
...
export TRAIN_DENSE_JSON=visdial_1.0_train_dense_annotations_${ANN_TYPE}.json

export TRAIN_LOG_FILE=$SAVE_MODEL_DIR/train_logs_${MODEL_NAME}_annotations_${ANN_TYPE}.txt
...
--train-dense-json $DATA_DIR/$TRAIN_DENSE_JSON \
...
--data_dir $DATA_DIR \
--gpu-ids $GPU_ID \
--dense_annotation_type $ANN_TYPE >> $TRAIN_LOG_FILE # provide more ids for multi-GPU execution other args...
